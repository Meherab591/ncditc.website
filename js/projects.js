// Projects data - EDIT THIS ARRAY TO ADD/MODIFY PROJECTS
const projects = [
  {
  ...
  return `
        <div class="card project-card">
            ...
            <div class="project-buttons">
                <a href="${project.github}" class="btn btn-outline" style="flex: 1;">
                ...
                <a href="${project.demo}" class="btn btn-primary" style="flex: 1;">
